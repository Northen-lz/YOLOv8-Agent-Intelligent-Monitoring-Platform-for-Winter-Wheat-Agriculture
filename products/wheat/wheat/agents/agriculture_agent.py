...
from ha_framework.tools.builtin.calculator import CalculatorTool
from ha_framework.tools.builtin.image_caption_tool import ImageCaptionTool
from ha_framework.tools.builtin.memory_tool import MemoryTool
from ha_framework.tools.builtin.note_tool import NoteTool
from ha_framework.tools.builtin.protocol_tools import MCPTool
from ha_framework.tools.builtin.rag_tool import RAGTool
from ha_framework.tools.builtin.terminal_tool import TerminalTool
from ha_framework.tools.registry import ToolRegistry
from ha_framework.agents.react_agent import ReActAgent
    ...
    def __init__(self, name="agriculture_expert", llm=None, system_prompt=None,
        ...
        try:
            weather_script = os.path.join(
                Config.PROJECT_ROOT, "wheat", "tools", "agriculture", "weather_mcp_server.py")
