...
示例:
    python ssh_upload_stdin.py app.py /opt/hello-agents/hello_agents/app.py \
        "chown www-data:www-data /opt/hello-agents/hello_agents/app.py && systemctl restart hello-agents"
"""
import os
import sys
